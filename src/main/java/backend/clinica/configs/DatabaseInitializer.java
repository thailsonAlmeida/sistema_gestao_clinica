...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    private void seedSchedulings() {
        entityManager.createNativeQuery("INSERT INTO TB_SCHEDULING (PROFESSIONAL_ID, PATIENT_ID, DATE_HOUR, IS_CONFIRMED, IS_PRESENT, IS_CANCEL) VALUES (1, 5, '2025-08-10T10:14', false, false, false)").executeUpdate();
        entityManager.createNativeQuery("INSERT INTO TB_SCHEDULING (PROFESSIONAL_ID, PATIENT_ID, DATE_HOUR, IS_CONFIRMED, IS_PRESENT, IS_CANCEL) VALUES (1, 5, '2025-08-10T10:14', false, false, false)").executeUpdate();
        entityManager.createNativeQuery("INSERT INTO TB_SCHEDULING (PROFESSIONAL_ID, PATIENT_ID, DATE_HOUR, IS_CONFIRMED, IS_PRESENT, IS_CANCEL) VALUES (1, 5, '2025-08-10T10:14', true, false, false)").executeUpdate();
        entityManager.createNativeQuery("INSERT INTO TB_SCHEDULING (PROFESSIONAL_ID, PATIENT_ID, DATE_HOUR, IS_CONFIRMED, IS_PRESENT, IS_CANCEL) VALUES (2, 4, '2025-08-11T13:14', false, false, false)").executeUpdate();
        entityManager.createNativeQuery("INSERT INTO TB_SCHEDULING (PROFESSIONAL_ID, PATIENT_ID, DATE_HOUR, IS_CONFIRMED, IS_PRESENT, IS_CANCEL) VALUES (3, 3, '2025-08-13T07:14', true, false, false)").executeUpdate();
        entityManager.createNativeQuery("INSERT INTO TB_SCHEDULING (PROFESSIONAL_ID, PATIENT_ID, DATE_HOUR, IS_CONFIRMED, IS_PRESENT, IS_CANCEL) VALUES (4, 2, '2025-08-14T08:14', false, false, false)").executeUpdate();
        entityManager.createNativeQuery("INSERT INTO TB_SCHEDULING (PROFESSIONAL_ID, PATIENT_ID, DATE_HOUR, IS_CONFIRMED, IS_PRESENT, IS_CANCEL) VALUES (5, 1, '2025-08-15T09:14', true, false, false)").executeUpdate();
    }
